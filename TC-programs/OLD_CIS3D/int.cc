...
int main(int argc, char* argv[]){
  ...
  ofstream outf(dumc);
  outf << "Calcuating peak integral \n";
  outf << "-------------------------------------------------------------------------------\n";
  outf << "Reading input form " << argv[1] << "\n\n";


  //INPUT DATA
//   int    wpoints;          //nr of points to use for integration
//   int    nrops;            //nrots in input file
//   int    nr_col;           //nr of collums in input file
//   int    w_col;            //colum with t
//   int    sig_col;          //colum with signal
  ...
  outf << "Using " << tpoints << " for integration.\n";
