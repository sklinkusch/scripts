...
void calc_det(int i, int nroe, int llim, int ulim, int* dets, double* facs, int* nr){
  ...
  static int g1 = 0;
  static int g2 = omo*umo;
  static int g3 = 2*omo*umo;
  static int g4 = 2*omo*umo + omo*sum1;
  static int g5 = 2*omo*umo + omo*sum1 + sum2*umo;
  static int g6 = 2*omo*umo + omo*sum1 + sum2*umo + sum1*sum2;
  static int g7 = 2*omo*umo + omo*sum1 + sum2*umo + 2*sum1*sum2;
