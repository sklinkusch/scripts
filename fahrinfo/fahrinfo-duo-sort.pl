...
sub checkNet {
  ...
  close ACPJ;
  Fahrinfo::sort_entries(\@apretext,\@apreenctext,\@bpretext,\@bpreenctext,\@text,\@enctext);
...
sub print_exit {
  print "Gebrauch: fahrinfo-duo-sort.pl \"Haltestelle1\" \"Haltestelle2\" <dep/arr> <code> <Zeile1> <Zeile2>\n";
