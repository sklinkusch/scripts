...
sub checkNet {
  ...
  close ACPI;
  Fahrinfo::filter_sgl($farrliniespec,\@farrlinie,\@arrtext,\@arrenctext,\@farrtext,\@farrenctext);
  open (ACPJ, "$depcommand |") || die "can't open pipe!";
  Fahrinfo::read_fahrinfo(\*ACPJ,$station,\@deptext,\@depenctext);
  close ACPJ;
  Fahrinfo::filter_sgl($fdepliniespec,\@fdeplinie,\@deptext,\@depenctext,\@fdeptext,\@fdepenctext);
